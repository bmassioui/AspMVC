...
namespace TvShowsWebApp.Controllers
{
    public class TvShowsController : Controller
    {
        ...
        public TvShowsController(ApplicationDbContext context, ILogger<TvShowsController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Title,Genre,Rating,ImdbUrl,IsDeleted")] TvShow tvShow)
        {
            if (id != tvShow.Id)
            {
                return NotFound();
